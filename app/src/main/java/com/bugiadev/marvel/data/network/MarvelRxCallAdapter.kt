package com.bugiadev.marvel.data.network
...
class MarvelRxCallAdapterFactory(
    private val rxCallAdapterFactory: RxJava2CallAdapterFactory
): CallAdapter.Factory() {

    companion object {
        fun create(): MarvelRxCallAdapterFactory {
            return MarvelRxCallAdapterFactory(RxJava2CallAdapterFactory.create())
        }
    }
    ...
    override fun get(
        ...
        return MarvelRxCallAdapter(annotations, retrofit, rxJava2CallAdapter)
    }
}

private class MarvelRxCallAdapter constructor(
